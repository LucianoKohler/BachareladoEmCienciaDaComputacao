...
geraComando classe tabelaVars tabelaFuns (For atrib expr inc bloco) = do
    labelInicio <- novoLabel
    labelVerdadeiro <- novoLabel
    labelFalso <- novoLabel
    atrib' <- geraComando classe tabelaVars tabelaFuns atrib
    expr' <- geraExprL classe tabelaVars tabelaFuns labelVerdadeiro labelFalso expr
    inc' <- geraComando classe tabelaVars tabelaFuns inc
    bloco' <- geraBloco classe tabelaVars tabelaFuns bloco
    return (atrib' ++ labelInicio ++ ":\n" ++ expr' ++ labelVerdadeiro ++ ":\n" ++ bloco' ++ inc' ++ "\tgoto " ++ labelInicio ++ "\n" ++ labelFalso ++ ":\n")
