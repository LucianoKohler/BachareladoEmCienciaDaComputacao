...
public class ArquivoContatoDAO {
  ...
  public List<Contato> leContatosArquivo() throws ErroNaLeituraException {
    return stringToListaContato(arquivo.leTexto(caminho));
  }

  public void gravaContatosArquivo(List<Contato> contatos) throws ErroNaGravacaoException {
