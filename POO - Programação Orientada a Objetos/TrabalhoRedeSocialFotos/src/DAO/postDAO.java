...
public class postDAO {
  ...
  public static ArrayList<Post> verFavoritosDeUmUser(int idUser){
    ...
    try {
      ...
      if(resultado.next()){
        do{
          Post p = postDAO.buscarPorId(resultado.getInt("idPost"));
          if (p != null) {
            favoritos.add(p);
          }
        }while(resultado.next());
  ...
  public static ArrayList<User> verUsersQueFavoritaramPost(int idPost){
    ...
    try {
      ...
      if(resultado.next()){
        do {
          User u = userDAO.buscarPorId(resultado.getInt("idUsuario"));
          users.add(u);
        } while(resultado.next());
      }
      statement.close();
  ...
  public static void desFavoritarPost(int idUser, int idPost){
